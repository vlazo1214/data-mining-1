...
and dividing them by 10, causing an 83% correlation. This scales down x1's values and creates a linear relationship:
...
In this case, we reject a null hypothesis of B_1 = 0.

(f) Do the results obtained in (c)–(e) contradict each other? Explain your answer.

In part (c), we saw that x2 did not have a significant p-value whereas in part (e) x2 did have a significant p-value. This is because both x1 and x2 were used in the model which weakening each individual feature's performance. 
...
Adding this new observation resulted in the x2 variable being significant in all cases where it's used. The x1 variable had less significance as well. The y ~ x2 model was able to explain 20% of the data whereas the y ~ x1 model only explained 15%. These show that this new observation is an outlier and a high leverage point.
